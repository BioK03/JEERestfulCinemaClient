var Category = {
	...
	getDetails: function(data) {
		var result = '<h3>Details de la categorie</h3>'
	...
	getAddForm: function() {
		var result = `<h3>Ajout d'une catégorie</h3>
			<div class="form">
				...
				<button class="clickable btn" data-action="categoryAddSumbit"><i class="fa fa-check"></i>Valider</button>
			</div>
			`;
		printResults("#mainContent", result);
	},
	getEditForm: function(data) {
		var result = '<h3>Edition d\'une catégorie</h3>'
			+'<div class="form">'
				...
				+'<button class="clickable btn" data-action="categoryEditSumbit"><i class="fa fa-check"></i>Valider</button>'
				+'</div>';
		printResults("#mainContent", result);
	},
};