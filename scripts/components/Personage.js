var Personage = {
	...
	getDetails: function(data) {
		var result = '<h3>Details du personnage</h3>'
			+'<button class="clickable btn" data-action="personageEdit" data-args="'+data[0].movie.noMovie+'/'+data[0].actor.noAct+'"><i class="fa fa-edit"></i> Editer ce personnage</button>'
	...
	getAddForm: function() {
		var result = `<h3>Ajout d'un personage</h3>
			<div class="form">
				...
				<button class="clickable btn" data-action="personageAddSumbit"><i class="fa fa-check"></i>Valider</button>
			</div>
			`;
		printResults("#mainContent", result);
	...
	getEditForm: function(data) {
		var result = '<h3>Edition d\'un personnage</h3>'
			+'<div class="form">'
				...
				+'<button class="clickable btn" data-action="personageEditSumbit" data-args="'+data[0].movie.noMovie+'/'+data[0].actor.noAct+'"><i class="fa fa-check"></i>Valider</button>'
			+'</div>';
		printResults("#mainContent", result);
	},
};